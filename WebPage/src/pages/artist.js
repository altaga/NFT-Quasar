          ...
          this.state.elements.length > 0 ?
            <div className="body-style" id="body-style">
              <div style={{ paddingTop: "40px" }}>
                ...
                <Col>
                  <Button className="quasarButton" style={{ width: "16vw", borderRadius: "10px", fontSize: "1.5rem", borderRight: "1px solid black", background: ` #000`, marginRight: "10px" }} onClick={() => window.open(JSON.parse(this.state.elements[0].Data).external_url, "_blank")}>Artist URL</Button>
                  {
                ...
                </Col>
                {
                  ...
                  <h3 style={{ paddingTop: "4vh" }}>
                    <Button className="quasarButton" disabled={!this.state.pendingButton} style={{ width: "16vw", borderRadius: "10px", fontSize: "1.5rem", background: ` #000` }} onClick={() => {
                      //pending
                      ...
                      return (
                        <div key={"element" + index} style={{ margin: "10px" }}>
                          <Card style={{ width: "15vw", height: "34vh" }}>
                            ...
                            <CardBody>
                              <CardTitle tag="h4">{JSON.parse(item.Data).attributes[0].artist}</CardTitle>
                              <CardSubtitle tag="h6" >
                                <div className="flexbox-style">
                                  <div>
                                    {"Price:"}
