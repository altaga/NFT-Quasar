                                            ...
                                            return (
                                                <Col style={{ width: "20vw" }}>
                                                    <Card key={index + "element"} style={{ margin: "6px" }}>
                                                        ...
                                                        <CardBody>
                                                            <CardSubtitle style={{ paddingBottom: "6px" }} tag="h4" >{JSON.parse(element.Data).attributes[0].artist}</CardSubtitle>
                                                            <CardSubtitle style={{ paddingBottom: "6px" }} tag="h4" >
                                                                <div className="flexbox-style">
                                                                    ...
                                                                    <>&nbsp;</>
                                                                    <div style={{color:"yellow", textShadow:`-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000`, paddingBottom:"5px"}}>γ</div>
                                                                    {
                                                            ...
                                                            <Button className="quasarButton" style={{ width: "200px", borderRadius: "10px", fontSize: "1.3rem", background: ` #000` }} onClick={() => {
                                                                window.open(`/artist/${element.PubKey}`, "_blank");
                                                            }}>Open Gallery</Button>
                                                            <div style={{ height: "1vh" }} />
                                                            {
                                                                typeof (this.state.generalOrders[element.PubKey]) !== "undefined" &&
                                                                <Button className="quasarButton" disabled={!parseInt(this.state.generalOrders[element.PubKey].state)} style={{ width: "200px", borderRadius: "10px", fontSize: "1.3rem", background: ` #000` }} onClick={() => {
                                                                    this.setState({
                                ...
                                <Row>
                                    <Col xs="3">
                                        ...
                                        <Button
                                            ...
                                            style={{ width: "200px", borderRadius: "10px", fontSize: "1.5rem", background: ` #000` }}>
                                            Order NOW
                                        </Button>
                                    </Col>
                                    <Col xs="9">
                                                    ...
                                                    return (
                                                        <Col key={"element" + index} style={{ margin: "10px" }}>
                                                            <Card style={{ width: "15vw", height: "34vh" }}>
                                                                ...
                                                                <CardBody>
                                                                    <CardTitle tag="h4">{JSON.parse(item.Data).name}</CardTitle>
                                                                    <CardSubtitle tag="h6" >
                                                                        <div className="flexbox-style">
                                                                            <div>
                                                                                {"Price:"}
                                                                    ...
                                                                    <Button className="quasarButton" style={{ width: "200px", borderRadius: "10px", fontSize: "1.5rem", background: ` #000` }} onClick={() => {
